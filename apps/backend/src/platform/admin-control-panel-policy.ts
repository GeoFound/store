export const ADMIN_CONTROL_PANEL_POLICY = {
  ...
  productionControlRule:
    "Any capability that can affect launch, revenue, fulfillment, customer access, security, cost, provider state, data, backup, rollback, compliance, or a human production decision must appear in the backend control panel and must map to an executable gate or explicit evidence field before production promotion.",
  admissionCriteria: [
    {
    ...
    },
    {
      ...
      description:
        "The capability contributes to staging, production promotion, go-live, rollback, or irreversible runtime decisions.",
    },
    {
      id: "runtime-evidence",
      title: "Runtime evidence",
      description:
        "The capability needs real runtime proof, smoke checks, provider probes, or generated evidence before it is safe to rely on.",
    },
  ],
  requiredSurface: [
    {
    ...
    },
    {
      ...
      title: "Evidence",
      description:
        "Expose the command, timestamp, result, report path, or evidence reference used by production gates.",
    },
    {
      id: "production-gates",
      title: "Production gates",
      description:
        "Show which site lifecycle controls and evidence fields block promotion.",
    },
    {
      id: "safe-empty-state",
  ...
  forbiddenSurface: [
    {
      ...
      description:
        "Never render API secrets, database URLs, Redis URLs, private keys, certificate private keys, or provider tokens.",
    },
    {
    ...
    },
    {
      ...
      description:
        "Never allow go-live, rollback, DNS mutation, WAF mutation, Access mutation, data migration, or production write enablement without an explicit human gate and machine evidence.",
    },
    {
  ...
  requiredProductionSurfaces: [
    ...
    },
    {
      ...
      runtimeCommands: ["pnpm deploy:dns", "pnpm deploy:edge"],
      configKeys: [
    ...
    },
    {
      ...
      configKeys: ["PLISIO_API_KEY", "PLISIO_CALLBACK_BASE_URL", "MANUAL_WEBHOOK_SECRET"],
    },
    {
    ...
    },
    {
      ...
      runtimeCommands: ["pnpm deploy:regression"],
      configKeys: ["CREDENTIAL_ENCRYPTION_KEY", "DELIVERY_ENCRYPTION_KEY"],
    },
    {
      id: "customer-access",
    ...
    },
    {
      ...
      configKeys: ["RESEND_ENABLED", "RESEND_API_KEY", "RESEND_FROM_EMAIL"],
    },
    {
