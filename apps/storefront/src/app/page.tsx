          ...
          <div className="mx-auto grid max-w-6xl gap-8 px-4 py-10 sm:px-6 lg:grid-cols-[1fr_360px] lg:items-center">
            <div>
              <h1 className="max-w-3xl text-4xl font-semibold tracking-normal text-stone-950 sm:text-5xl">
                Digital goods, delivered from your order page.
              </h1>
              <p className="mt-4 max-w-2xl text-base leading-7 text-stone-700">
                Browse, checkout as a guest, pay, and use your order access link
                to view delivery details. No account is required to buy.
              </p>
            ...
            <div className="overflow-hidden border border-stone-200 bg-stone-100">
              <div className="aspect-[4/3] bg-[linear-gradient(135deg,#0f766e_0%,#0f766e_45%,#f97316_45%,#f97316_68%,#1c1917_68%)]" />
            </div>
          </div>
          ...
          <div className="mb-5 flex items-end justify-between gap-4">
            <div>
              ...
              <p className="mt-1 text-sm text-stone-600">
                Managed by Medusa, sold through this storefront.
              </p>
            </div>
